...
class SiteController extends Controller
{
    ...
    {
        $slider = Slider::find()->limit(3)->all();
        $notices = Notices::find()->all();
        $academics = Academics::find()->limit(5)->all();
        $message = \common\models\Message::find()->one();
    ...
    {
        $model = Notices::find()->where(['notice_id' => $id])->one();
    ...
    public function actionGallerydetail($id)
    {
        ...
        return $this->render('gallerydetail',[
            'model' => $model,
        ]);
    }
